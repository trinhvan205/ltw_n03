...
namespace Day09_DatabaseFirst_ShoppingCart.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        private readonly ShoppingCartTaoTuCodeFirstContext _context;

        public LoaiSanPhamsController(ShoppingCartTaoTuCodeFirstContext context)
        {
            _context = context;
        }
